...
namespace Bska.Client.UI.ViewModels.AssetViewModel
{
    ...
    public sealed class BelongingViewModel : BaseDetailsViewModel<Belonging>
    {
        #region ctor

        public BelongingViewModel(Belonging currentEntity)
            :base(currentEntity)
        {
        ...
        [Required(ErrorMessage = "مال اصلی الزامی است")]
        public UnConsumption Parent
        {
            get { return CurrentEntity.ParentMAsset; }
            set
            {
                CurrentEntity.ParentMAsset = value;
