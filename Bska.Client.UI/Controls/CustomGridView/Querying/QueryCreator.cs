...
namespace Bska.Client.UI.Controls.CustomGridView.Querying
{
    public class QueryCreator
    {
        ...
        private StringBuilder createSingleFilter(FilterData filterData)
        {
            ...
            if (
                ...
                || filterData.Type==FilterType.PersianTimeBetween)
                &&
            ...
            out object parameterValue, string stringValue, Type type)
        {
            ...
            try
            {
                ...
                else if(type == typeof(Nullable<PersianDate>) || type == typeof(PersianDate))
                {
                    parameterValue = PersianDate.Parse(stringValue);
                }
                else if (type == typeof(Enum) || type.BaseType == typeof(Enum))
                {
                    parameterValue = Enum.Parse(type, stringValue, true);
                }
